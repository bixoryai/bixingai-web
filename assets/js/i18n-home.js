...
window.translations.en = Object.assign({}, window.translations.en, {
  ...
  "insights.subtitle": "Stay informed about trends and innovations in AI",
...
window.translations.zh = Object.assign({}, window.translations.zh, {
  ...
  "hero.floatingCard5": "AI教育",
  
  // Services Section
  "services.title": "我们的服务",
  "services.subtitle": "根据您的业务需求量身定制的全面AI解决方案",
  "services.education.title": "AI教育培训",
  "services.education.description": "通过定制培训计划和工作坊为您的团队提供AI知识。",
  ...
  "services.consultation.description": "为在整个组织中实施AI以推动创新和效率提供战略指导。",
  "services.consultation.feature1": "AI就绪评估",
  "services.consultation.feature2": "实施路线图",
  "services.consultation.feature3": "技术选型",
  ...
  "demo.description2": "这些演示仅展示了我们定制AI开发服务所能实现的一小部分。",
  "demo.placeholder": "互动AI演示",
  "demo.placeholderSmall": "点击体验AI实战",
  "demo.viewAll": "查看所有演示",
