...
const translations = {
  ...
  'zh': {
    ...
    // Footer
    "footer.description": "通过创新的AI解决方案赋能企业，推动增长和效率。",
    ...
    "footer.terms": "服务条款",
    "footer.contact": "联系我们",
    "footer.address": "美国加利福尼亚州硅谷AI创新中心123号，邮编94000",
    "footer.email": "info@bixingtechnology.com",
    "footer.phone": "+1 (555) 123-4567",
    "footer.copyright": " 2023 成都毕行科技有限公司。保留所有权利。",
    "footer.company": "成都毕行科技有限公司",
    "footer.education": "AI教育培训",
    "footer.customSolutions": "AI定制解决方案",
    "footer.consultation": "企业AI咨询",
    "contact.description": "联系我们，了解成都毕行科技有限公司如何帮助您利用AI的力量实现业务目标。",
