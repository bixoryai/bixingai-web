...
const translations = {
  ...
  'zh': {
    ...
    "consultation.hero.subtitle": "为您的组织提供战略指导，通过AI实施推动创新、提高效率和增强竞争优势。",
    ...
    "consultation.overview.paragraph2": "毕行科技的企业AI咨询服务提供全面指导，帮助您的组织应对AI采用和实施的复杂性。我们经验丰富的顾问团队将深厚的技术知识与商业洞察力相结合，制定量身定制的战略，推动可衡量的结果。",
    "consultation.overview.paragraph3": "无论您刚刚开始AI之旅，还是希望优化现有计划，我们的咨询方法确保您的AI投资能够带来最大价值和竞争优势。",
    ...
    "consultation.services.readiness.description": "评估您组织的当前能力、基础设施和文化，确定AI就绪性并识别关键机会领域。",
    ...
    "consultation.services.strategy.description": "创建与您的业务目标和组织能力相一致的AI实施全面路线图。",
    ...
    "consultation.services.technology.description": "在复杂的AI技术领域中导航，为您的特定需求识别和选择最佳工具、平台和解决方案。",
    ...
    "consultation.services.change.description": "制定策略以促进组织对AI的采用，解决文化挑战并培养数据驱动的思维方式。",
    ...
    "consultation.services.governance.description": "建立负责任的AI使用框架，解决伦理考虑、监管合规和风险管理。",
    ...
    "consultation.approach.strategy.description": "我们制定全面的AI战略和实施路线图，根据您组织的特定需求、能力和目标量身定制。",
    ...
    "consultation.approach.measurement.description": "我们帮助您建立指标和流程来衡量成功，识别改进机会，并持续优化您的AI计划。",
    ...
    "consultation.testimonials.quote1": "毕行科技的咨询服务在帮助我们制定全面的AI战略方面发挥了重要作用。他们的系统方法、深厚的专业知识和对业务成果的关注使我们能够识别高价值机会并实施AI解决方案，显著提高了我们的运营效率。",
    "consultation.testimonials.author1": "David Wilson",
    "consultation.testimonials.position1": "全球制造公司首席信息官",
    "consultation.testimonials.quote2": "毕行科技进行的AI就绪性评估为我们组织的能力和差距提供了宝贵的见解。他们的战略指导帮助我们确定计划优先级、有效分配资源并建立确保负责任AI使用的治理框架。我们现在看到了AI投资的切实成果。",
    "consultation.testimonials.author2": "Jennifer Lee",
