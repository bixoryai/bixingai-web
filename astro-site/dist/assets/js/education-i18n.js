...
const educationTranslations = {
  en: {
    ...
    'education.hero.description':
      'Our customized training programs bridge knowledge gaps and prepare your organization for an AI-driven future.',
    ...
    'education.overview.paragraph2':
      'Whether you\'re looking to upskill your technical teams, help business leaders make informed AI decisions, or create organization-wide AI literacy, our customized programs provide practical, actionable knowledge that can be immediately applied to real-world challenges.',
    'education.overview.paragraph3':
      'Our approach combines theoretical foundations with hands-on experience, ensuring participants not only understand AI concepts but can confidently apply them in their day-to-day work.',
    ...
    'education.benefits.experts.description':
      'Learn from industry professionals with extensive AI experience and teaching capabilities.',
    'education.benefits.support.title': 'Ongoing Support',
    'education.benefits.support.description':
      'Continued assistance and resources after training completion to ensure successful application.'
  },
  zh: {
    // Page title and meta
    ...
    'education.benefits.customized.description':
      '根据您团队的特定需求和技能水平定制的计划，确保相关且有影响力的学习。',
...
function applyEducationTranslations(lang) {
  ...
  document.querySelectorAll('[data-i18n-alt]').forEach(element => {
    ...
    if (translations[key]) {
      ...
      // Translation key not found, keep original alt text
    }
  });
