...
const translations = {
  en: {
    ...
    'consultation.overview.paragraph1':
      ...
      'implementing AI effectively requires more than just technical expertise—it demands a strategic ' +
      'approach that aligns with your business objectives and organizational culture.',
    ...
    'services.education.detailDescription':
      'Empower your workforce with the knowledge and skills needed to leverage AI technologies effectively. Our customized training programs are designed to bridge the AI knowledge gap at all levels of your organization.',
    'services.education.feature4':
      'Comprehensive curriculum covering AI fundamentals to advanced topics',
    ...
    'services.customSolutions.detailDescription':
      'From data preparation to model deployment, we develop end-to-end AI solutions tailored to your specific business challenges. Our team of experts works closely with you to create AI applications that deliver measurable results.',
    ...
    'services.consultation.detailDescription':
      'Navigate the complex AI landscape with strategic guidance from our experienced consultants. We help you identify opportunities, assess readiness, and develop a comprehensive roadmap for AI implementation across your organization.',
    ...
    'services.cta.description':
      'Contact us today to discuss how our AI solutions can address your specific challenges and opportunities.',
    ...
    'demo.description2':
      'These demos showcase just a fraction of what\'s possible with our custom AI development services.',
    ...
    'portfolio.manufacturing.description':
      'Implemented predictive maintenance AI that reduced downtime by 35% for a global manufacturing client.',
    ...
    'portfolio.financial.description':
      'Created a fraud detection system that reduced false positives by 42% while increasing detection accuracy for a financial institution.',
    ...
    'testimonials.quote1':
      'Bixing Technology transformed our approach to data analysis. Their custom AI solution has given us insights we never thought possible.',
    'testimonials.author1': 'Jane Smith',
    'testimonials.position1': 'CTO, Enterprise Company',
    'testimonials.quote2':
      'The AI training program developed by Bixing has significantly accelerated our team\'s capabilities. Highly recommended!',
    ...
    'insights.article2.excerpt':
      'Recent breakthroughs in machine learning models and what they mean for business applications.',
    ...
    'insights.article3.excerpt':
      'A practical guide to successfully implementing AI solutions in various business contexts.',
    ...
    'footer.privacyPolicyContent':
      'At Bixing Technology, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and protect your personal information.',
    'footer.termsOfServiceContent':
      'By using our website, you agree to our Terms of Service. Please read this document carefully before using our services.',
    ...
    'education.hero.subtitle':
      'Empower your team with the knowledge and skills to leverage AI effectively',
    'education.hero.description':
      'Our customized training programs bridge the knowledge gap and prepare your organization for the AI-driven future.',
    ...
    'education.overview.subtitle':
      'Comprehensive AI education tailored to your organization\'s needs',
    ...
    'education.overview.paragraph2':
      'Whether you\'re looking to upskill technical teams, help business leaders make informed AI decisions, or create organization-wide AI literacy, our customized programs deliver practical, actionable knowledge that can be immediately applied to real-world challenges.',
    'education.overview.paragraph3':
      'Our approach combines theoretical foundations with hands-on experience, ensuring participants not only understand AI concepts but can apply them confidently in their daily work.',
    ...
    'education.benefits.customized.description':
      'Programs tailored to your team\'s specific needs and skill levels, ensuring relevant and impactful learning.',
    'education.benefits.handson.title': 'Hands-on Experience',
    'education.benefits.handson.description':
      'Practical exercises and real-world projects that reinforce concepts and build confidence.',
    'education.benefits.experts.title': 'Expert Instructors',
    'education.benefits.experts.description':
      'Learn from industry professionals with extensive AI experience and proven teaching abilities.',
    'education.benefits.support.title': 'Continuous Support',
    'education.benefits.support.description':
      'Ongoing assistance and resources after training completion to ensure successful application.',
    ...
    'education.programs.executive.description':
      'Strategic overview of AI capabilities, limitations, and business applications for leadership teams.',
    'education.programs.technical.title': 'Technical AI Implementation',
    'education.programs.technical.description':
      'Hands-on training for technical teams on AI development, deployment, and maintenance.',
    'education.programs.organizational.title': 'Organization-Wide AI Awareness',
    'education.programs.organizational.description':
      'Foundational AI concepts and applications for all employees to foster innovation and adoption.',
    'education.programs.custom.title': 'Custom Training Solutions',
    'education.programs.custom.description':
      'Tailored programs designed for your specific industry, use cases, and organizational goals.',
    ...
    'education.programs.fundamentals.description':
      'Comprehensive introduction to AI concepts, technologies, and applications for technical and non-technical professionals.',
    ...
    'education.programs.bootcamp.description':
      'Intensive hands-on training for technical teams on building and deploying AI solutions.',
    ...
    'education.approach.paragraph1':
      'We believe that effective AI education goes beyond theoretical concepts. Our training programs are designed to be engaging, practical, and directly applicable to your organization\'s specific challenges and opportunities.',
    'education.approach.paragraph2':
      'Through a combination of interactive workshops, hands-on projects, real-world case studies, and ongoing guidance, we ensure participants not only understand AI concepts but can confidently apply them in their day-to-day work.',
    ...
    'education.testimonials.quote1':
      'The customized AI training program from Bixing Technology has transformed how our product development teams approach innovation. The practical, hands-on approach ensured that our teams could immediately apply what they learned.',
    'education.testimonials.author1': 'Sarah Chen, CTO, TechInnovate',
    'education.testimonials.quote2':
      'As a non-technical executive, I found the AI literacy program incredibly valuable. It provided me with the knowledge I needed to make informed strategic decisions about AI implementation without getting lost in technical details.',
    'education.testimonials.author2': 'Michael Rodriguez, CEO, Global Finance Solutions',
    'education.testimonials.quote3':
      'The organization-wide AI awareness program helped us build a culture of innovation. Employees across departments now collaborate on AI initiatives, resulting in several successful projects that have improved our operations.',
    ...
    'education.faq.a1':
      'No, our programs are designed for various skill levels, from complete beginners to experienced practitioners. We tailor the content to match your team\'s existing knowledge and learning objectives.',
    'education.faq.q2': 'How long do the training programs typically last?',
    'education.faq.a2':
      'Program duration varies based on content depth and your organization\'s needs. Executive programs may be 1-2 days, while technical programs typically span 4-8 weeks with part-time commitment. We offer flexible scheduling options.',
    'education.faq.q3': 'Can training be conducted remotely or must it be in-person?',
    'education.faq.a3':
      'We offer both in-person and remote training options. Our virtual programs use interactive platforms to ensure engagement and practical application, while in-person sessions provide more hands-on collaboration opportunities.',
    'education.faq.q4': 'How do you measure the effectiveness of the training?',
    'education.faq.a4':
      'We establish clear learning objectives at the outset and use various assessment methods throughout the program. We also conduct follow-up evaluations to measure knowledge retention and practical application in the workplace.',
    'education.faq.q5': 'Can you integrate our company\'s data and use cases into the training?',
    'education.faq.a5':
      'Yes, we strongly encourage this approach. Using your organization\'s actual data and business challenges makes the training more relevant and immediately applicable. We work with you to identify appropriate use cases while respecting data privacy requirements.',
    'education.cta.title': 'Ready to Empower Your Team with AI Knowledge?',
    'education.cta.description':
      'Contact us to discuss how our AI education programs can be tailored to your organization\'s specific needs and goals.',
    ...
    'casestudy.education.subtitle':
      'A comprehensive AI training program that upskilled 200+ professionals across technical and business teams',
    ...
    'casestudy.education.overview1':
      'Siemens, a global technology leader, recognized the need to integrate AI capabilities across their organization to maintain competitive advantage and drive innovation. They partnered with Bixing Technology to develop and deliver a comprehensive AI education program that would upskill their workforce from basic AI literacy to advanced AI application development and deployment.',
    'casestudy.education.overview2':
      'The program needed to address diverse learning needs across technical and business teams, provide practical hands-on experience, and align with Siemens\' specific industry applications and use cases.',
    'casestudy.keyresults': 'Key Results',
    'casestudy.education.result1':
      'Trained over 200 professionals across engineering, product development, and business units',
    'casestudy.education.result2':
      '94% of participants reported confidence in applying AI concepts to their daily work',
    'casestudy.education.result3':
      '12 internal AI projects initiated within 3 months of program completion',
    'casestudy.education.result4':
      'Reduced external AI consultancy costs by 40% through internal capability building',
    'casestudy.education.testimonial':
    ...
    'casestudy.education.challenge1':
      'Siemens faced several challenges in their AI transformation journey:',
    'casestudy.education.challenge1title': 'Diverse Technical Backgrounds',
    'casestudy.education.challenge1text':
      'Participants ranged from data scientists with advanced degrees to business managers with limited technical exposure, requiring highly adaptable training approaches.',
    'casestudy.education.challenge2title': 'Industry-Specific Applications',
    'casestudy.education.challenge2text':
      'Generic AI training wouldn\'t suffice; content needed to be relevant to manufacturing, automation, and industrial IoT contexts.',
    'casestudy.education.challenge3title': 'Practical Application Gap',
    'casestudy.education.challenge3text':
      'Previous training initiatives had failed to bridge the gap between theoretical knowledge and practical implementation.',
    'casestudy.education.challenge4title': 'Global Coordination',
    'casestudy.education.challenge4text':
      'Training needed to be delivered across multiple time zones and locations while maintaining consistent quality and engagement.',
    'casestudy.approach': 'Our Approach',
    'casestudy.education.approachIntro':
      'Bixing Technology developed a multi-tiered, customized approach to address Siemens\' specific needs:',
    'casestudy.education.approach1title': '1. Comprehensive Needs Assessment',
    'casestudy.education.approach1text':
      'We began with a thorough analysis of Siemens\' existing AI capabilities, interviewing stakeholders across departments to identify specific knowledge gaps and learning objectives. This allowed us to create targeted learning paths for different roles and departments.',
    'casestudy.education.approach2title': '2. Customized Curriculum Development',
    'casestudy.education.approach2text':
      'We designed a modular curriculum with three distinct tracks: AI Fundamentals for business teams, Applied AI for technical implementers, and Advanced AI Development for specialized technical teams. Each module incorporated Siemens-specific use cases and industry applications.',
    'casestudy.education.approach3title': '3. Hands-On Learning Environment',
    'casestudy.education.approach3text':
      'We created a secure, cloud-based learning environment with pre-configured tools and datasets relevant to Siemens\' operations. This allowed participants to immediately apply concepts through guided exercises and mini-projects without complex setup requirements.',
    'casestudy.education.approach4title': '4. Expert-Led Live Sessions',
    'casestudy.education.approach4text':
      'Our team of AI specialists with industry experience delivered interactive live sessions that combined theory with practical demonstrations. These sessions included real-time coding exercises, model building, and problem-solving workshops.',
    'casestudy.education.approach5title': '5. Capstone Projects',
    'casestudy.education.approach5text':
      'Participants worked in cross-functional teams on real business challenges identified by Siemens leadership. These projects served as both learning vehicles and potential solutions for actual business needs, creating immediate ROI from the training program.',
    ...
    'casestudy.education.modulesIntro':
      'Our comprehensive curriculum covered the full spectrum of AI knowledge and skills:',
    ...
    'casestudy.education.resultsIntro':
      'The comprehensive AI education program delivered significant measurable outcomes for Siemens:',
    ...
    'casestudy.education.impact2':
      'Reduced dependency on external AI consultants by building internal capabilities',
    'casestudy.education.impact3': 'Improved cross-functional collaboration on AI initiatives',
    'casestudy.education.impact4':
      'Created a common AI language and framework across the organization',
    'casestudy.education.impact5':
      'Established a pipeline of AI talent and champions within the company',
    'casestudy.education.projectOutcomes': 'Project Outcomes',
    'casestudy.education.outcome1':
      'Developed a predictive maintenance system that reduced equipment downtime by 27%',
    'casestudy.education.outcome2':
      'Created an automated quality inspection system using computer vision',
    'casestudy.education.outcome3':
      'Implemented an NLP solution to streamline technical documentation analysis',
    'casestudy.education.outcome4':
      'Built an AI-powered supply chain optimization tool that reduced inventory costs by 15%',
    'casestudy.education.ctaTitle': 'Transform Your Organization with AI Education',
    'casestudy.education.ctaText':
      'Ready to empower your team with the AI skills needed to drive innovation and competitive advantage? Contact us to discuss how our customized AI education programs can address your specific business challenges.',
    ...
    'education.process.assessment.description':
      'We evaluate your team\'s current knowledge and identify specific learning needs to create a targeted educational plan.',
    'education.process.curriculum.title': 'Curriculum Design',
    'education.process.curriculum.description':
      'Custom development of training materials and learning paths aligned with your organization\'s goals and industry context.',
    'education.process.training.title': 'Interactive Training',
    'education.process.training.description':
      'Engaging workshops combining theory and hands-on practice to ensure knowledge retention and skill development.',
    'education.process.projects.title': 'Applied Projects',
    'education.process.projects.description':
      'Real-world applications to reinforce learning and demonstrate practical value to your organization.',
    'education.process.evaluation.title': 'Evaluation & Feedback',
    'education.process.evaluation.description':
      'Measuring progress and gathering insights for continuous improvement of both participants and our programs.',
    'education.process.ongoing.title': 'Ongoing Support',
    'education.process.ongoing.description':
      'Resources and assistance to continue the learning journey and address challenges as they arise in implementation.'
  },
  zh: {
    // Page title
    ...
    'consultation.hero.subtitle':
      '为您的组织提供战略指导，通过AI实施推动创新、提高效率和增强竞争优势。',
    'consultation.overview.title': '战略性AI实施',
    'consultation.overview.subtitle': '通过全面的AI战略转变您的业务',
    'consultation.overview.paragraph1':
      '在当今快速发展的技术环境中，有效实施AI不仅需要技术专长，还需要与您的业务目标和组织文化相一致的战略方法。',
    'consultation.overview.paragraph2':
      '毕行科技的企业AI咨询服务提供全面指导，帮助您的组织应对AI采用和实施的复杂性。我们经验丰富的顾问团队将深厚的技术知识与商业洞察力相结合，制定量身定制的战略，推动可衡量的结果。',
    'consultation.overview.paragraph3':
      '无论您刚刚开始AI之旅，还是希望优化现有计划，我们的咨询方法确保您的AI投资能够带来最大价值和竞争优势。',
    'consultation.overview.image.alt': 'AI战略框架',
    'consultation.services.title': '我们的咨询服务',
    'consultation.services.subtitle': '为您的AI之旅提供全面支持',
    'consultation.services.readiness.title': 'AI就绪性评估',
    'consultation.services.readiness.description':
      '评估您组织的当前能力、基础设施和文化，确定AI就绪性并识别关键机会领域。',
    ...
    'consultation.services.strategy.title': 'AI战略制定',
    'consultation.services.strategy.description':
      '创建与您的业务目标和组织能力相一致的AI实施全面路线图。',
    ...
    'consultation.services.technology.description':
      '在复杂的AI技术领域中导航，为您的特定需求识别和选择最佳工具、平台和解决方案。',
    ...
    'consultation.services.change.description':
      '制定策略以促进组织对AI的采用，解决文化挑战并培养数据驱动的思维方式。',
    ...
    'consultation.services.roi.title': 'ROI与价值评估',
    'consultation.services.roi.description':
    ...
    'consultation.approach.subtitle': '成功实施AI的系统方法',
    ...
    'consultation.approach.strategy.description':
      '我们制定全面的AI战略和实施路线图，根据您组织的特定需求、能力和目标量身定制。',
    ...
    'consultation.approach.measurement.description':
      '我们帮助您建立指标和流程来衡量成功，识别改进机会，并持续优化您的AI计划。',
    'consultation.industries.title': '我们服务的行业',
    'consultation.industries.subtitle': '跨多个领域的专业AI咨询',
    'consultation.industries.healthcare': '医疗健康',
    ...
    'consultation.testimonials.quote1':
      '毕行科技的咨询服务在帮助我们制定全面的AI战略方面发挥了重要作用。他们的系统方法、深厚的专业知识和对业务成果的关注使我们能够识别高价值机会并实施AI解决方案，显著提高了我们的运营效率。',
    'consultation.testimonials.author1': 'David Wilson',
    'consultation.testimonials.position1': '全球制造公司首席信息官',
    'consultation.testimonials.quote2':
      '毕行科技进行的AI就绪性评估为我们组织的能力和差距提供了宝贵的见解。他们的战略指导帮助我们确定计划优先级、有效分配资源并建立确保负责任AI使用的治理框架。我们现在看到了AI投资的切实成果。',
    'consultation.testimonials.author2': 'Jennifer Lee',
    ...
    'services.consultation.detailDescription':
      '在我们经验丰富的顾问的战略指导下，驾驭复杂的AI领域。我们帮助您识别机会，评估准备情况，并为您的组织制定全面的AI实施路线图。',
    'services.stats.projects': '100+',
    ...
    'portfolio.financial.description':
      '为金融机构创建的欺诈检测系统，减少了42%的误报同时提高了检测准确性。',
    'portfolio.financial.readMore': '阅读案例研究',
    'portfolio.education.title': '西门子AI教育培训',
    'portfolio.education.description':
      '为西门子提供全面AI培训计划，提升200多名专业人员从AI基础到高级AI应用开发和部署的技能。',
    ...
    'testimonials.quote1':
      '成都毕行科技有限公司彻底改变了我们的数据分析方法。他们的定制AI解决方案为我们提供了前所未有的洞察力。',
    'testimonials.author1': 'Jane Smith',
    'testimonials.position1': '企业公司首席技术官',
    'testimonials.quote2':
      '成都毕行科技有限公司开发的AI培训计划显著加速了我们团队的能力。强烈推荐！',
    'testimonials.author2': 'Michael Johnson',
    ...
    'footer.privacyPolicyContent':
      '在成都毕行科技有限公司，我们致力于保护您的隐私。这项隐私政策解释了我们如何收集、使用和保护您的个人信息。',
    'footer.termsOfServiceContent':
      '使用我们的网站，即表示您同意我们的服务条款。请仔细阅读此文档，然后再使用我们的服务。',
    ...
    'education.overview.text':
      '毕行科技提供全面的AI教育计划，旨在为各级组织人员提供所需的知识和技能，以有效利用AI技术。我们的培训由行业专家设计和交付，结合理论学习和实践应用，确保参与者能够将所学知识应用到实际业务挑战中。',
    'education.overview.paragraph1':
      '在当今快速发展的技术环境中，AI素养已成为关键的竞争优势。毕行科技的AI教育和培训计划旨在为您的团队提供在特定行业环境中有效利用AI所需的实用知识和技能。',
    'education.overview.paragraph2':
      '无论您是希望提升技术团队的技能，帮助业务领导者做出明智的AI决策，还是创建全组织范围的AI素养，我们的定制计划都提供可立即应用于现实世界挑战的实用、可操作的知识。',
    'education.overview.paragraph3':
      '我们的方法将理论基础与实践经验相结合，确保参与者不仅理解AI概念，还能在日常工作中自信地应用它们。',
    'education.benefits.title': '主要优势',
    'education.benefits.subtitle': '我们的AI教育方法的独特价值',
    'education.benefits.benefit1.title': '定制化学习',
    'education.benefits.benefit1.text':
      '根据您组织的特定需求、行业和技术成熟度量身定制的培训计划。',
    'education.benefits.benefit2.title': '实践导向',
    'education.benefits.benefit2.text':
      '基于项目的学习方法，使参与者能够通过解决实际业务挑战来应用AI概念。',
    'education.benefits.benefit3.title': '专家指导',
    'education.benefits.benefit3.text':
      '由拥有丰富行业经验的AI专家提供的培训和指导，提供实用见解。',
    'education.benefits.benefit4.title': '全面课程',
    'education.benefits.benefit4.text':
      '涵盖从AI基础到高级主题的全面课程，满足各种角色和技能水平的需求。',
    'education.benefits.card1.title': '定制化学习路径',
    'education.benefits.card1.text':
      '根据您组织的特定需求和目标量身定制的课程，从AI基础到高级应用。',
    'education.benefits.card2.title': '行业专家讲师',
    'education.benefits.card2.text':
      '向在各行业实施AI解决方案方面拥有丰富实战经验的资深AI从业者学习。',
    'education.benefits.card3.title': '实践导向学习',
    'education.benefits.card3.text':
      '专注于实际应用和真实场景，确保您的团队能够立即应用他们的新AI技能。',
    'education.process.title': '培训流程',
    'education.process.subtitle': '我们如何提供有效的AI教育',
    'education.process.step1.title': '需求评估',
    'education.process.step1.text':
      '我们与您的团队合作，了解您的业务目标、现有技能和特定培训需求。',
    ...
    'education.process.step3.text':
      '由行业专家主导的引人入胜、实践性强的课程，结合理论与实际应用。',
    ...
    'education.testimonials.testimonial1.content':
      'AI基础课程为我们的营销团队提供了与数据科学部门有效协作所需的知识。这显著加速了我们的AI驱动营销计划。',
    'education.testimonials.testimonial1.name': 'Sarah Johnson',
    'education.testimonials.testimonial1.position': '全球零售公司CMO',
    'education.testimonials.testimonial2.content':
      '毕行的应用AI培训改变了我们的开发团队。完成课程后的三个月内，我们成功地在生产环境中实施了第一个机器学习模型。',
    ...
    'education.faq.a1':
      '我们的项目针对各种角色和经验水平设计。AI基础项目适合需要了解AI概念的非技术专业人员。应用AI项目最适合将直接参与实施AI解决方案的技术团队成员。AI领导力项目专为负责AI战略的高管和决策者量身定制。',
    'education.faq.q2': '参与者需要之前的编程经验吗？',
    'education.faq.a2':
      '对于AI基础项目，不需要编程经验。对于应用AI项目，建议具备基本的编程知识（最好是Python）。如果需要，我们可以提供预培训资源帮助参与者做好准备。',
    'education.faq.q3': '您能提供特定行业的定制培训吗？',
    'education.faq.a3':
      '是的，我们专注于行业特定的定制化。我们的培训项目可以针对您所在行业的独特AI应用、挑战和机会进行定制，无论是医疗保健、金融、制造、零售还是任何其他行业。',
    'education.faq.q4': '您提供虚拟培训选项吗？',
    'education.faq.a4':
      '是的，我们所有的培训项目都提供面对面和虚拟形式。我们的虚拟培训保持与面对面课程相同的互动性和实践性，并配备额外的数字协作工具，确保引人入胜的学习体验。',
    'education.faq.q5': '培训后您提供什么持续支持？',
    'education.faq.a5':
      '所有参与者在培训后6个月内都可以访问我们的在线学习门户，获取额外资源、练习和参考材料。我们还提供可选的后续咨询会议，帮助团队将新知识应用到特定项目中。'
  }
};
